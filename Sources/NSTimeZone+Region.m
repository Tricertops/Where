...
+ (NSDictionary *)timeZoneRegionComponents {
    ...
    dispatch_once(&onceToken, ^{
        codes = @{
                  ...
                  @"Africa/Asmera": @[ @"ER", @15.33333, @38.88333 ], // Link: Africa/Asmara
                  ...
                  @"Africa/Timbuktu": @[ @"CI", @5.31667, @-3.96667 ], // Link: Africa/Abidjan
                  ...
                  @"America/Argentina/ComodRivadavia": @[ @"AR", @-27.53333, @-64.21667 ], // Link: America/Argentina/Catamarca
                  ...
                  @"America/Atka": @[ @"US", @51.88000, @-175.34194 ], // Link: America/Adak
                  ...
                  @"America/Buenos_Aires": @[ @"AR", @-33.40000, @-57.55000 ], // Link: America/Argentina/Buenos_Aires
                  ...
                  @"America/Catamarca": @[ @"AR", @-27.53333, @-64.21667 ], // Link: America/Argentina/Catamarca
                  ...
                  @"America/Coral_Harbour": @[ @"CA", @48.75861, @-90.37833 ], // Link: America/Atikokan
                  @"America/Cordoba": @[ @"AR", @-30.60000, @-63.81667 ], // Link: America/Argentina/Cordoba
                  ...
                  @"America/Ensenada": @[ @"MX", @32.53333, @-116.98333 ], // Link: America/Tijuana
                  @"America/Fort_Wayne": @[ @"US", @39.76833, @-85.84194 ], // Link: America/Indiana/Indianapolis
                  ...
                  @"America/Indianapolis": @[ @"US", @39.76833, @-85.84194 ], // Link: America/Indiana/Indianapolis
                  ...
                  @"America/Jujuy": @[ @"AR", @-23.81667, @-64.70000 ], // Link: America/Argentina/Jujuy
                  ...
                  @"America/Knox_IN": @[ @"US", @41.29583, @-85.37500 ], // Link: America/Indiana/Knox
                  ...
                  @"America/Louisville": @[ @"US", @38.25417, @-84.24056 ], // Link: America/Kentucky/Louisville
                  ...
                  @"America/Mendoza": @[ @"AR", @-31.11667, @-67.18333 ], // Link: America/Argentina/Mendoza
                  ...
                  @"America/Porto_Acre": @[ @"BR", @-8.03333, @-66.20000 ], // Link: America/Rio_Branco
                  ...
                  @"America/Rosario": @[ @"AR", @-30.60000, @-63.81667 ], // Link: America/Argentina/Cordoba
                  ...
                  @"America/Shiprock": @[ @"US", @39.73917, @-103.01583 ], // Link: America/Denver
                  ...
                  @"America/Virgin": @[ @"TT", @10.65000, @-60.48333 ], // Link: America/Port_of_Spain
                  ...
                  @"Antarctica/South_Pole": @[ @"NZ", @-35.13333, @174.76667 ], // Link: Pacific/Auckland
                  ...
                  @"Asia/Ashkhabad": @[ @"TM", @37.95000, @58.38333 ], // Link: Asia/Ashgabat
                  ...
                  @"Asia/Calcutta": @[ @"IN", @22.53333, @88.36667 ], // Link: Asia/Kolkata
                  ...
                  @"Asia/Chongqing": @[ @"CN", @31.23333, @121.46667 ], // Link: Asia/Shanghai
                  @"Asia/Chungking": @[ @"CN", @31.23333, @121.46667 ], // Link: Asia/Shanghai
                  @"Asia/Colombo": @[ @"LK", @6.93333, @79.85000 ],
                  @"Asia/Dacca": @[ @"BD", @23.71667, @90.41667 ], // Link: Asia/Dhaka
                  ...
                  @"Asia/Harbin": @[ @"CN", @31.23333, @121.46667 ], // Link: Asia/Shanghai
                  ...
                  @"Asia/Kashgar": @[ @"CN", @43.80000, @87.58333 ], // Link: Asia/Urumqi
                  @"Asia/Kathmandu": @[ @"NP", @27.71667, @85.31667 ],
                  @"Asia/Katmandu": @[ @"NP", @27.71667, @85.31667 ], // Link: Asia/Kathmandu
                  ...
                  @"Asia/Macao": @[ @"MO", @22.23333, @113.58333 ], // Link: Asia/Macau
                  ...
                  @"Asia/Saigon": @[ @"VN", @10.75000, @106.66667 ], // Link: Asia/Ho_Chi_Minh
                  ...
                  @"Asia/Tel_Aviv": @[ @"IL", @31.78056, @35.22389 ], // Link: Asia/Jerusalem
                  @"Asia/Thimbu": @[ @"BT", @27.46667, @89.65000 ], // Link: Asia/Thimphu
                  @"Asia/Thimphu": @[ @"BT", @27.46667, @89.65000 ],
                  @"Asia/Tokyo": @[ @"JP", @35.65444, @139.74472 ],
                  @"Asia/Ujung_Pandang": @[ @"ID", @-4.88333, @119.40000 ], // Link: Asia/Makassar
                  @"Asia/Ulaanbaatar": @[ @"MN", @47.91667, @106.88333 ], // most locations
                  @"Asia/Ulan_Bator": @[ @"MN", @47.91667, @106.88333 ], // Link: Asia/Ulaanbaatar
                  ...
                  @"Atlantic/Faeroe": @[ @"FO", @62.01667, @-5.23333 ], // Link: Atlantic/Faroe
                  @"Atlantic/Faroe": @[ @"FO", @62.01667, @-5.23333 ],
                  @"Atlantic/Jan_Mayen": @[ @"NO", @59.91667, @10.75000 ], // Link: Europe/Oslo
                  ...
                  @"Australia/ACT": @[ @"AU", @-32.13333, @151.21667 ], // Link: Australia/Sydney
                  ...
                  @"Australia/Canberra": @[ @"AU", @-32.13333, @151.21667 ], // Link: Australia/Sydney
                  ...
                  @"Australia/LHI": @[ @"AU", @-30.45000, @159.08333 ], // Link: Australia/Lord_Howe
                  ...
                  @"Australia/NSW": @[ @"AU", @-32.13333, @151.21667 ], // Link: Australia/Sydney
                  @"Australia/North": @[ @"AU", @-11.53333, @130.83333 ], // Link: Australia/Darwin
                  @"Australia/Perth": @[ @"AU", @-30.05000, @115.85000 ], // Western Australia - most locations
                  @"Australia/Queensland": @[ @"AU", @-26.53333, @153.03333 ], // Link: Australia/Brisbane
                  @"Australia/South": @[ @"AU", @-33.08333, @138.58333 ], // Link: Australia/Adelaide
                  @"Australia/Sydney": @[ @"AU", @-32.13333, @151.21667 ], // New South Wales - most locations
                  @"Australia/Tasmania": @[ @"AU", @-41.11667, @147.31667 ], // Link: Australia/Hobart
                  @"Australia/Victoria": @[ @"AU", @-36.18333, @144.96667 ], // Link: Australia/Melbourne
                  @"Australia/West": @[ @"AU", @-30.05000, @115.85000 ], // Link: Australia/Perth
                  @"Australia/Yancowinna": @[ @"AU", @-30.05000, @141.45000 ], // Link: Australia/Broken_Hill
                  @"Brazil/Acre": @[ @"BR", @-8.03333, @-66.20000 ], // Link: America/Rio_Branco
                  @"Brazil/DeNoronha": @[ @"BR", @-2.15000, @-31.58333 ], // Link: America/Noronha
                  @"Brazil/East": @[ @"BR", @-22.46667, @-45.38333 ], // Link: America/Sao_Paulo
                  @"Brazil/West": @[ @"BR", @-2.86667, @-59.98333 ], // Link: America/Manaus
                  @"Canada/Atlantic": @[ @"CA", @44.65000, @-62.40000 ], // Link: America/Halifax
                  @"Canada/Central": @[ @"CA", @49.88333, @-96.85000 ], // Link: America/Winnipeg
                  @"Canada/East-Saskatchewan": @[ @"CA", @50.40000, @-103.35000 ], // Link: America/Regina
                  @"Canada/Eastern": @[ @"CA", @43.65000, @-78.61667 ], // Link: America/Toronto
                  @"Canada/Mountain": @[ @"CA", @53.55000, @-112.53333 ], // Link: America/Edmonton
                  @"Canada/Newfoundland": @[ @"CA", @47.56667, @-51.28333 ], // Link: America/St_Johns
                  @"Canada/Pacific": @[ @"CA", @49.26667, @-122.88333 ], // Link: America/Vancouver
                  @"Canada/Saskatchewan": @[ @"CA", @50.40000, @-103.35000 ], // Link: America/Regina
                  @"Canada/Yukon": @[ @"CA", @60.71667, @-134.95000 ], // Link: America/Whitehorse
                  @"Chile/Continental": @[ @"CL", @-32.55000, @-69.33333 ], // Link: America/Santiago
                  @"Chile/EasterIsland": @[ @"CL", @-26.85000, @-108.56667 ], // Link: Pacific/Easter
                  @"Cuba": @[ @"CU", @23.13333, @-81.63333 ], // Link: America/Havana
                  @"Egypt": @[ @"EG", @30.05000, @31.25000 ], // Link: Africa/Cairo
                  @"Eire": @[ @"IE", @53.33333, @-5.75000 ], // Link: Europe/Dublin
                  @"Europe/Amsterdam": @[ @"NL", @52.36667, @4.90000 ],
                  @"Europe/Andorra": @[ @"AD", @42.50000, @1.51667 ],
                  @"Europe/Athens": @[ @"GR", @37.96667, @23.71667 ],
                  @"Europe/Belfast": @[ @"GB", @51.50833, @0.12528 ], // Link: Europe/London
                  ...
                  @"Europe/Tiraspol": @[ @"MD", @47.00000, @28.83333 ], // Link: Europe/Chisinau
                  ...
                  @"GB": @[ @"GB", @51.50833, @0.12528 ], // Link: Europe/London
                  @"GB-Eire": @[ @"GB", @51.50833, @0.12528 ], // Link: Europe/London
                  @"Hongkong": @[ @"HK", @22.28333, @114.15000 ], // Link: Asia/Hong_Kong
                  @"Iceland": @[ @"IS", @64.15000, @-20.15000 ], // Link: Atlantic/Reykjavik
                  ...
                  @"Iran": @[ @"IR", @35.66667, @51.43333 ], // Link: Asia/Tehran
                  @"Israel": @[ @"IL", @31.78056, @35.22389 ], // Link: Asia/Jerusalem
                  @"Jamaica": @[ @"JM", @17.96806, @-75.20667 ], // Link: America/Jamaica
                  @"Japan": @[ @"JP", @35.65444, @139.74472 ], // Link: Asia/Tokyo
                  @"Kwajalein": @[ @"MH", @9.08333, @167.33333 ], // Link: Pacific/Kwajalein
                  @"Libya": @[ @"LY", @32.90000, @13.18333 ], // Link: Africa/Tripoli
                  @"Mexico/BajaNorte": @[ @"MX", @32.53333, @-116.98333 ], // Link: America/Tijuana
                  @"Mexico/BajaSur": @[ @"MX", @23.21667, @-105.58333 ], // Link: America/Mazatlan
                  @"Mexico/General": @[ @"MX", @19.40000, @-98.85000 ], // Link: America/Mexico_City
                  @"NZ": @[ @"NZ", @-35.13333, @174.76667 ], // Link: Pacific/Auckland
                  @"NZ-CHAT": @[ @"NZ", @-42.05000, @-175.45000 ], // Link: Pacific/Chatham
                  @"Navajo": @[ @"US", @39.73917, @-103.01583 ], // Link: America/Denver
                  @"PRC": @[ @"CN", @31.23333, @121.46667 ], // Link: Asia/Shanghai
                  ...
                  @"Pacific/Ponape": @[ @"FM", @6.96667, @158.21667 ], // Link: Pacific/Pohnpei
                  ...
                  @"Pacific/Samoa": @[ @"AS", @-13.73333, @-169.30000 ], // Link: Pacific/Pago_Pago
                  ...
                  @"Pacific/Truk": @[ @"FM", @7.41667, @151.78333 ], // Link: Pacific/Chuuk
                  @"Pacific/Wake": @[ @"UM", @19.28333, @166.61667 ], // Wake Island
                  @"Pacific/Wallis": @[ @"WF", @-12.70000, @-175.83333 ],
                  @"Pacific/Yap": @[ @"FM", @7.41667, @151.78333 ], // Link: Pacific/Chuuk
                  @"Poland": @[ @"PL", @52.25000, @21.00000 ], // Link: Europe/Warsaw
                  @"Portugal": @[ @"PT", @38.71667, @-8.86667 ], // Link: Europe/Lisbon
                  @"ROC": @[ @"TW", @25.05000, @121.50000 ], // Link: Asia/Taipei
                  @"ROK": @[ @"KR", @37.55000, @126.96667 ], // Link: Asia/Seoul
                  @"Singapore": @[ @"SG", @1.28333, @103.85000 ], // Link: Asia/Singapore
                  @"Turkey": @[ @"TR", @41.01667, @28.96667 ], // Link: Europe/Istanbul
                  @"US/Alaska": @[ @"US", @61.21806, @-148.09972 ], // Link: America/Anchorage
                  @"US/Aleutian": @[ @"US", @51.88000, @-175.34194 ], // Link: America/Adak
                  @"US/Arizona": @[ @"US", @33.44833, @-111.92667 ], // Link: America/Phoenix
                  @"US/Central": @[ @"US", @41.85000, @-86.35000 ], // Link: America/Chicago
                  @"US/East-Indiana": @[ @"US", @39.76833, @-85.84194 ], // Link: America/Indiana/Indianapolis
                  @"US/Eastern": @[ @"US", @40.71417, @-73.99361 ], // Link: America/New_York
                  @"US/Hawaii": @[ @"US", @21.30694, @-156.14167 ], // Link: Pacific/Honolulu
                  @"US/Indiana-Starke": @[ @"US", @41.29583, @-85.37500 ], // Link: America/Indiana/Knox
                  @"US/Michigan": @[ @"US", @42.33139, @-82.95417 ], // Link: America/Detroit
                  @"US/Mountain": @[ @"US", @39.73917, @-103.01583 ], // Link: America/Denver
                  @"US/Pacific": @[ @"US", @34.05222, @-117.75722 ], // Link: America/Los_Angeles
                  @"US/Samoa": @[ @"AS", @-13.73333, @-169.30000 ], // Link: Pacific/Pago_Pago
                  @"W-SU": @[ @"RU", @55.75583, @37.61778 ], // Link: Europe/Moscow
                  };
    });
    return codes;
}
